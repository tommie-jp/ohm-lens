...
- **L\* と a\*/b\* はスケールを分けています**（値域が 0〜130 と −60〜80 で桁が違い、
  同じ軸に乗せると L\* の変化ばかりが目立つため）。目盛りは**左が L\***、
  **右が a\*/b\***。凡例にもどちらの軸かを書いています。
  a\* と b\* は 1 つのスケールを共有します
- どちらのスケールも、**最大値がプロット高の 90%、最小値が 10%** の位置に来るよう
  自動で合わせます（上下に余白が残るので線が枠に張り付きません）
